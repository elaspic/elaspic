...
class make_uniprot_pfam_database():
    ...
    def __init__(self, pfamA_clans_filename, pfamA_repeating_domains_filename, pfamA_superdomains_filename):
    ...
    def __join_domains(self, seq_record_canonical, seq_record1, seq_record2, join_type):
        ...
        if join_type == 'super':
            ...
            if seq_record1.annotations['clan_name'][0]:
                ...
                # Keep the name of the first pfam guy
