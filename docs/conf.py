# -*- coding: utf-8 -*-
#
# ELASPIC documentation build configuration file, created by
...
def linkcode_resolve(domain, info):
    ...
    url = (
        "https://github.com/kimlaborg/elaspic/blob/master/elaspic/{}".format(filename)
    )
    return url
...
latex_documents = [
    ('index', 'ELASPIC.tex', u'ELASPIC Documentation',
     u'kimlab', 'manual'),
]
...
man_pages = [
    ('index', 'elaspic', u'ELASPIC Documentation',
     [u'kimlab'], 1)
]
...
texinfo_documents = [
    ('index', 'ELASPIC', 'ELASPIC Documentation',
     'kimlab', 'ELASPIC', 'One line description of project.',
     'Miscellaneous'),
]
...
epub_title = u'ELASPIC'
epub_author = u'kimlab'
epub_publisher = u'kimlab'
epub_copyright = u'2015, kimlab'

# The basename for the epub file. It defaults to the project name.
# epub_basename = u'ELASPIC'
...
numpydoc_show_class_members = False  # tthis screws around autosummary
