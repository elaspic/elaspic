...
def test_read_build_model():
    ...
    output_file = op.join(
        op.splitext(__file__)[0],
        "{}-{}".format(pdb_id, foldx_mutation),
...
def _test_analyse_complex(
    structure_file_wt, structure_file_mut, pdb_chains, foldx, analyze_complex_results_
):
