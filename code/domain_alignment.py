        ...
        if canonical_domain:
            ...
            if isinstance(d, sql_db.UniprotDomain):
                for domain in domain_list:
                    ...
                    self.logger.debug('keeping domain with cluster id: %i, cluster idx: %i' % (domain.cdhit_cluster, domain.cdhit_cluster_idx))
...
#        self.logger.debug('Left overhang:\t %i,\t gap:\t %i,\t gap^2:\t %i,\t total:\t %i' % (overhang_length[0], gap_length[0], second_gap_length[0], extend_length[0]))
#        self.logger.debug('Right overhang:\t %i,\t gap:\t %i,\t gap^2:\t %i,\t total:\t %i' % (overhang_length[1], gap_length[1], second_gap_length[1], extend_length[1]))
