...
#
# import elaspic
# from elaspic.database import (LONG, MEDIUM, SHORT, Base, decode_domain_def,
#                               get_binary_collation)
...
#             (['pdb_pdbfam_name'], {'mysql_length': 255})
#         ]
#     cath_id = sa.Column(sa.String(SHORT, collation=get_binary_collation()), primary_key=True)
#     pdb_id = sa.Column(sa.String(SHORT), nullable=False)
#     pdb_chain = sa.Column(sa.String(SHORT, collation=get_binary_collation()), nullable=False)
#     _pdb_domain_def = sa.Column('pdb_domain_def', sa.String(MEDIUM), nullable=False)
...
#     # Other
#     _pdb_structure = None
#     _domain_structure = None
#
#     @property
#     def pdb_domain_def(self):
#         _pdb_domain_def = decode_domain_def(self._pdb_domain_def)
#         _, _, pdb_domain_def_start = self.structure.xtra['reverse_mapping'][
#             (0, self.pdb_chain, _pdb_domain_def[0])]
#         _, _, pdb_domain_def_stop = self.structure.xtra['reverse_mapping'][
#             (0, self.pdb_chain, _pdb_domain_def[-1])]
#         return slice(pdb_domain_def_start, pdb_domain_def_stop + 1)
#
#     @property
#     def pdb_structure(self):
#         if self._pdb_structure is not None:
#             return self._pdb_structure
#         s = structure_tools.fetch_structure(
#             pdb_id=self.pdb_id, pdb_type='cif', biounit=False,
#             pdb_mirror=elaspic.CONFIGS['pdb_dir'])
#         ps = structure_tools.process_structure(s)
#         self._pdb_structure = ps
#         return self._pdb_structure
#
#     @property
#     def domain_structure(self):
#         if self._domain_structure is not None:
#             return self._domain_structure
#         self._domain_structure = structure_tools.extract(
#             self.pdb_structure, self.pdb_chain, self.pdb_domain_def)
#         return self._domain_structure
#
#
...
#     @property
#     def pdb_structure(self):
#         return self.domain_1.pdb_structure
#
#     @property
#     def domain_structure(self):
#         if self._domain_structure is not None:
#             return self._domain_structure
#         self._domain_structure = structure_tools.extract(
#             self.domain_1.pdb_structure,
#             [self.domain_1.pdb_chain, self.domain_2.pdb_chain],
#             [self.domain_1.pdb_domain_def, self.domain_2.pdb_domain_def])
#         return self._domain_structure
#
#
