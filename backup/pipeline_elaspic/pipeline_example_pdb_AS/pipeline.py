...
class getInteractions:
    ...
    def __init__(self, database):
        ...
        !! Make sure to delete the old *.pickle files if the input data changes !!
                ...
                database[uniprotID] = 
                [uniprotID_firstGuy, interaction_type_firstGuy, PfamID_firstGuy, domain, interface, 
                uniprotID_secondGuy, interaction_type_secondGuy, PfamID_secondGuy, domain2]
                
                database['P51808'] = 
                [['P51808', '3DiD', 'Tctex-1', '16-114',
                '33,35,38,39,42,43,46,47,50,51,53,54,57,61,62,63,64,65,66,67,68,69,70,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,88,89,95,104,108,110,111',
                'P51808', '3DiD', 'Tctex-1', '16-114\r\n']]
        """
...
class get3DID(myDatabases):
    ...
    def __make_3did_table(self, threeDidFile):
        ...
        read the 3DID file and store the information in a dictionary
                dictionary[(PfamID_firstGuy, PfamID_secondGuy)] = 
                [[PDBid, chain_firstGuy, chain_secondGuy, AArange_firstGuy, AArange_secondGuy]]
        """
        database = dict()
