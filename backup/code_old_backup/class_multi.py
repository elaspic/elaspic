...
#            do_modelling = False
        ...
        print 'chains', chains
        print 'domains_pdb', domains_pdb 
        print 'sequence0', sequences[0]
        print 'sequence1', sequences[1]
        print 'alignments', alignments
        print 'mutations_uniprot', mutations_uniprot
        ...
        print "alignments", alignments
        print "chains", chains
        print "SWITCH_CHAIN", SWITCH_CHAIN
        print "HETflag", HETflag
        print "HETATMsInChain_SEQnumbering", HETATMsInChain_SEQnumbering
        ...
        print "mutations_foldX", mutations_foldX
    ...
    def __run(self):
        ...
        print "pdbFile_wt:", pdbFile_wt
        print "chains:", chains
        print "mutations_pdb", mutations
        print "modeller_path", modeller_path
        print "mutations_foldx", mutations_foldX
